...
public class DraggingHandlerScript : MonoBehaviour
{
    ...
    [SerializeField] public bool isSelfDraggable = false;
    ...
    void Update()
    {
        ...
        if (hit.collider != null && hit.collider.CompareTag("Stickers") && hit.collider.gameObject == gameObject && !isDragging)
        {
